        ...
        <div class="rounded-sm bg-zinc-900 border border-zinc-800 overflow-hidden">
            <div class="px-4 py-4 border-b border-zinc-800 flex items-center justify-between">
                <div>
                    ...
                    <h2 class="text-lg font-semibold uppercase tracking-wider">All Beacons</h2>
                </div>
                <button @click="$dispatch('open-scanner')" class="inline-flex items-center gap-2 border border-zinc-700 text-zinc-400 px-4 py-2 text-sm font-semibold tracking-wider uppercase transition hover:text-white hover:border-zinc-500">
