    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <h1 class="text-4xl font-bold uppercase tracking-wider">Beacon Types</h1>
            </div>
        ...
        <div class="rounded-sm bg-zinc-900 border border-zinc-800 overflow-hidden">
            <div class="px-4 py-4 border-b border-zinc-800">
                ...
                <h3 class="text-lg font-semibold uppercase tracking-wider">All Types</h3>
            </div>
                    ...
                    <tbody class="divide-y divide-zinc-800">
                        @foreach ($types as $type)
                            <tr class="hover:bg-zinc-800/50 transition">
                                ...
                                <td class="px-4 py-4 text-center text-zinc-400 text-sm">{{ $type->beacons_count }}</td>
                                <td class="px-4 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <button wire:click="delete({{ $type->id }})"
                                            wire:confirm="Delete this type? Beacons using it will have no type."
                    ...
                    <form wire:submit="save">
                        <div class="mb-4">
                            ...
                            <input type="text" wire:model="name"
                                ...
                                placeholder="e.g. Indoor, Outdoor, Event">
